...
class RL {
  ...
  static inline function get_INIT_OK(): Int return rl.impl.RLImpl.INIT_OK;

  public static var INIT_ERR_UNKNOWN(get, never): Int;
  static inline function get_INIT_ERR_UNKNOWN(): Int return rl.impl.RLImpl.INIT_ERR_UNKNOWN;

  public static var INIT_ERR_ALREADY_INITIALIZED(get, never): Int;
  static inline function get_INIT_ERR_ALREADY_INITIALIZED(): Int return rl.impl.RLImpl.INIT_ERR_ALREADY_INITIALIZED;

  public static var INIT_ERR_LOADER(get, never): Int;
  static inline function get_INIT_ERR_LOADER(): Int return rl.impl.RLImpl.INIT_ERR_LOADER;

  public static var INIT_ERR_ASSET_HOST(get, never): Int;
  static inline function get_INIT_ERR_ASSET_HOST(): Int return rl.impl.RLImpl.INIT_ERR_ASSET_HOST;

  public static var INIT_ERR_WINDOW(get, never): Int;
  static inline function get_INIT_ERR_WINDOW(): Int return rl.impl.RLImpl.INIT_ERR_WINDOW;

  public static var TICK_RUNNING(get, never): Int;
  static inline function get_TICK_RUNNING(): Int return rl.impl.RLImpl.TICK_RUNNING;

  public static var TICK_WAITING(get, never): Int;
  static inline function get_TICK_WAITING(): Int return rl.impl.RLImpl.TICK_WAITING;

  public static var TICK_FAILED(get, never): Int;
  static inline function get_TICK_FAILED(): Int return rl.impl.RLImpl.TICK_FAILED;

  public static var FLAG_WINDOW_RESIZABLE(get, never): Int;
  static inline function get_FLAG_WINDOW_RESIZABLE(): Int return rl.impl.RLImpl.FLAG_WINDOW_RESIZABLE;

  public static var FLAG_MSAA_4X_HINT(get, never): Int;
  static inline function get_FLAG_MSAA_4X_HINT(): Int return rl.impl.RLImpl.FLAG_MSAA_4X_HINT;

  public static var FLAG_VSYNC_HINT(get, never): Int;
  static inline function get_FLAG_VSYNC_HINT(): Int return rl.impl.RLImpl.FLAG_VSYNC_HINT;

  public static var CAMERA_PERSPECTIVE(get, never): Int;
  static inline function get_CAMERA_PERSPECTIVE(): Int return rl.impl.RLImpl.CAMERA_PERSPECTIVE;

  public static var CAMERA_ORTHOGRAPHIC(get, never): Int;
  static inline function get_CAMERA_ORTHOGRAPHIC(): Int return rl.impl.RLImpl.CAMERA_ORTHOGRAPHIC;

  public static var LOADER_QUEUE_TASK_OK(get, never): Int;
  static inline function get_LOADER_QUEUE_TASK_OK(): Int return rl.impl.RLImpl.LOADER_QUEUE_TASK_OK;

  public static var LOADER_QUEUE_TASK_ERR_INVALID(get, never): Int;
  static inline function get_LOADER_QUEUE_TASK_ERR_INVALID(): Int return rl.impl.RLImpl.LOADER_QUEUE_TASK_ERR_INVALID;

  public static var LOADER_QUEUE_TASK_ERR_QUEUE_FULL(get, never): Int;
  static inline function get_LOADER_QUEUE_TASK_ERR_QUEUE_FULL(): Int return rl.impl.RLImpl.LOADER_QUEUE_TASK_ERR_QUEUE_FULL;

  public static var LOGGER_LEVEL_TRACE(get, never): Int;
  static inline function get_LOGGER_LEVEL_TRACE(): Int return rl.impl.RLImpl.LOGGER_LEVEL_TRACE;

  public static var LOGGER_LEVEL_DEBUG(get, never): Int;
  static inline function get_LOGGER_LEVEL_DEBUG(): Int return rl.impl.RLImpl.LOGGER_LEVEL_DEBUG;

  public static var LOGGER_LEVEL_INFO(get, never): Int;
  static inline function get_LOGGER_LEVEL_INFO(): Int return rl.impl.RLImpl.LOGGER_LEVEL_INFO;

  public static var LOGGER_LEVEL_WARN(get, never): Int;
  static inline function get_LOGGER_LEVEL_WARN(): Int return rl.impl.RLImpl.LOGGER_LEVEL_WARN;

  public static var LOGGER_LEVEL_ERROR(get, never): Int;
  static inline function get_LOGGER_LEVEL_ERROR(): Int return rl.impl.RLImpl.LOGGER_LEVEL_ERROR;

  public static var LOGGER_LEVEL_FATAL(get, never): Int;
  static inline function get_LOGGER_LEVEL_FATAL(): Int return rl.impl.RLImpl.LOGGER_LEVEL_FATAL;

  public static var COLOR_DEFAULT(get, never): RLHandle;
  static inline function get_COLOR_DEFAULT(): RLHandle return rl.impl.RLImpl.COLOR_DEFAULT;

  public static var COLOR_LIGHTGRAY(get, never): RLHandle;
  static inline function get_COLOR_LIGHTGRAY(): RLHandle return rl.impl.RLImpl.COLOR_LIGHTGRAY;

  public static var COLOR_GRAY(get, never): RLHandle;
  static inline function get_COLOR_GRAY(): RLHandle return rl.impl.RLImpl.COLOR_GRAY;

  public static var COLOR_YELLOW(get, never): RLHandle;
  static inline function get_COLOR_YELLOW(): RLHandle return rl.impl.RLImpl.COLOR_YELLOW;

  public static var COLOR_GOLD(get, never): RLHandle;
  static inline function get_COLOR_GOLD(): RLHandle return rl.impl.RLImpl.COLOR_GOLD;

  public static var COLOR_ORANGE(get, never): RLHandle;
  static inline function get_COLOR_ORANGE(): RLHandle return rl.impl.RLImpl.COLOR_ORANGE;

  public static var COLOR_PINK(get, never): RLHandle;
  static inline function get_COLOR_PINK(): RLHandle return rl.impl.RLImpl.COLOR_PINK;

  public static var COLOR_RED(get, never): RLHandle;
  static inline function get_COLOR_RED(): RLHandle return rl.impl.RLImpl.COLOR_RED;

  public static var COLOR_MAROON(get, never): RLHandle;
  static inline function get_COLOR_MAROON(): RLHandle return rl.impl.RLImpl.COLOR_MAROON;

  public static var COLOR_GREEN(get, never): RLHandle;
  static inline function get_COLOR_GREEN(): RLHandle return rl.impl.RLImpl.COLOR_GREEN;

  public static var COLOR_LIME(get, never): RLHandle;
  static inline function get_COLOR_LIME(): RLHandle return rl.impl.RLImpl.COLOR_LIME;

  public static var COLOR_DARKGREEN(get, never): RLHandle;
  static inline function get_COLOR_DARKGREEN(): RLHandle return rl.impl.RLImpl.COLOR_DARKGREEN;

  public static var COLOR_SKYBLUE(get, never): RLHandle;
  static inline function get_COLOR_SKYBLUE(): RLHandle return rl.impl.RLImpl.COLOR_SKYBLUE;

  public static var COLOR_BLUE(get, never): RLHandle;
  static inline function get_COLOR_BLUE(): RLHandle return rl.impl.RLImpl.COLOR_BLUE;

  public static var COLOR_DARKBLUE(get, never): RLHandle;
  static inline function get_COLOR_DARKBLUE(): RLHandle return rl.impl.RLImpl.COLOR_DARKBLUE;

  public static var COLOR_PURPLE(get, never): RLHandle;
  static inline function get_COLOR_PURPLE(): RLHandle return rl.impl.RLImpl.COLOR_PURPLE;

  public static var COLOR_VIOLET(get, never): RLHandle;
  static inline function get_COLOR_VIOLET(): RLHandle return rl.impl.RLImpl.COLOR_VIOLET;

  public static var COLOR_DARKPURPLE(get, never): RLHandle;
  static inline function get_COLOR_DARKPURPLE(): RLHandle return rl.impl.RLImpl.COLOR_DARKPURPLE;

  public static var COLOR_BEIGE(get, never): RLHandle;
  static inline function get_COLOR_BEIGE(): RLHandle return rl.impl.RLImpl.COLOR_BEIGE;

  public static var COLOR_BROWN(get, never): RLHandle;
  static inline function get_COLOR_BROWN(): RLHandle return rl.impl.RLImpl.COLOR_BROWN;

  public static var COLOR_DARKBROWN(get, never): RLHandle;
  static inline function get_COLOR_DARKBROWN(): RLHandle return rl.impl.RLImpl.COLOR_DARKBROWN;

  public static var COLOR_DARKGRAY(get, never): RLHandle;
  static inline function get_COLOR_DARKGRAY(): RLHandle return rl.impl.RLImpl.COLOR_DARKGRAY;

  public static var COLOR_WHITE(get, never): RLHandle;
  static inline function get_COLOR_WHITE(): RLHandle return rl.impl.RLImpl.COLOR_WHITE;

  public static var COLOR_BLANK(get, never): RLHandle;
  static inline function get_COLOR_BLANK(): RLHandle return rl.impl.RLImpl.COLOR_BLANK;

  public static var COLOR_MAGENTA(get, never): RLHandle;
  static inline function get_COLOR_MAGENTA(): RLHandle return rl.impl.RLImpl.COLOR_MAGENTA;

  public static var COLOR_RAYWHITE(get, never): RLHandle;
  static inline function get_COLOR_RAYWHITE(): RLHandle return rl.impl.RLImpl.COLOR_RAYWHITE;

  public static var COLOR_BLACK(get, never): RLHandle;
  static inline function get_COLOR_BLACK(): RLHandle return rl.impl.RLImpl.COLOR_BLACK;
  ...
  public static function initValuesInt(
  ...
  public static function loaderImportAsset(filename: String) {
    ...
    return @await rl.impl.RLImpl.loaderImportAsset(filename);
