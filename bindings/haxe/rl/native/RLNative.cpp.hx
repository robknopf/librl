...
class RLNative {
  ...
  static inline function get_INIT_OK(): Int return RLImpl.INIT_OK;

  public static var INIT_ERR_UNKNOWN(get, never): Int;
  static inline function get_INIT_ERR_UNKNOWN(): Int return RLImpl.INIT_ERR_UNKNOWN;

  public static var INIT_ERR_ALREADY_INITIALIZED(get, never): Int;
  static inline function get_INIT_ERR_ALREADY_INITIALIZED(): Int return RLImpl.INIT_ERR_ALREADY_INITIALIZED;

  public static var INIT_ERR_LOADER(get, never): Int;
  static inline function get_INIT_ERR_LOADER(): Int return RLImpl.INIT_ERR_LOADER;

  public static var INIT_ERR_ASSET_HOST(get, never): Int;
  static inline function get_INIT_ERR_ASSET_HOST(): Int return RLImpl.INIT_ERR_ASSET_HOST;

  public static var INIT_ERR_WINDOW(get, never): Int;
  static inline function get_INIT_ERR_WINDOW(): Int return RLImpl.INIT_ERR_WINDOW;

  public static var TICK_RUNNING(get, never): Int;
  static inline function get_TICK_RUNNING(): Int return RLImpl.TICK_RUNNING;

  public static var TICK_WAITING(get, never): Int;
  static inline function get_TICK_WAITING(): Int return RLImpl.TICK_WAITING;

  public static var TICK_FAILED(get, never): Int;
  static inline function get_TICK_FAILED(): Int return RLImpl.TICK_FAILED;

  public static var FLAG_WINDOW_RESIZABLE(get, never): Int;
  static inline function get_FLAG_WINDOW_RESIZABLE(): Int return RLImpl.FLAG_WINDOW_RESIZABLE;

  public static var FLAG_MSAA_4X_HINT(get, never): Int;
  static inline function get_FLAG_MSAA_4X_HINT(): Int return RLImpl.FLAG_MSAA_4X_HINT;

  public static var FLAG_VSYNC_HINT(get, never): Int;
  static inline function get_FLAG_VSYNC_HINT(): Int return RLImpl.FLAG_VSYNC_HINT;

  public static var CAMERA_PERSPECTIVE(get, never): Int;
  static inline function get_CAMERA_PERSPECTIVE(): Int return RLImpl.CAMERA_PERSPECTIVE;

  public static var CAMERA_ORTHOGRAPHIC(get, never): Int;
  static inline function get_CAMERA_ORTHOGRAPHIC(): Int return RLImpl.CAMERA_ORTHOGRAPHIC;

  public static var LOADER_QUEUE_TASK_OK(get, never): Int;
  static inline function get_LOADER_QUEUE_TASK_OK(): Int return RLImpl.LOADER_QUEUE_TASK_OK;

  public static var LOADER_QUEUE_TASK_ERR_INVALID(get, never): Int;
  static inline function get_LOADER_QUEUE_TASK_ERR_INVALID(): Int return RLImpl.LOADER_QUEUE_TASK_ERR_INVALID;

  public static var LOADER_QUEUE_TASK_ERR_QUEUE_FULL(get, never): Int;
  static inline function get_LOADER_QUEUE_TASK_ERR_QUEUE_FULL(): Int return RLImpl.LOADER_QUEUE_TASK_ERR_QUEUE_FULL;

  public static var LOGGER_LEVEL_TRACE(get, never): Int;
  static inline function get_LOGGER_LEVEL_TRACE(): Int return RLImpl.LOGGER_LEVEL_TRACE;

  public static var LOGGER_LEVEL_DEBUG(get, never): Int;
  static inline function get_LOGGER_LEVEL_DEBUG(): Int return RLImpl.LOGGER_LEVEL_DEBUG;

  public static var LOGGER_LEVEL_INFO(get, never): Int;
  static inline function get_LOGGER_LEVEL_INFO(): Int return RLImpl.LOGGER_LEVEL_INFO;

  public static var LOGGER_LEVEL_WARN(get, never): Int;
  static inline function get_LOGGER_LEVEL_WARN(): Int return RLImpl.LOGGER_LEVEL_WARN;

  public static var LOGGER_LEVEL_ERROR(get, never): Int;
  static inline function get_LOGGER_LEVEL_ERROR(): Int return RLImpl.LOGGER_LEVEL_ERROR;

  public static var LOGGER_LEVEL_FATAL(get, never): Int;
  static inline function get_LOGGER_LEVEL_FATAL(): Int return RLImpl.LOGGER_LEVEL_FATAL;

  public static var COLOR_DEFAULT(get, never): RLHandle;
  static inline function get_COLOR_DEFAULT(): RLHandle return RLImpl.COLOR_DEFAULT;

  public static var COLOR_LIGHTGRAY(get, never): RLHandle;
  static inline function get_COLOR_LIGHTGRAY(): RLHandle return RLImpl.COLOR_LIGHTGRAY;

  public static var COLOR_GRAY(get, never): RLHandle;
  static inline function get_COLOR_GRAY(): RLHandle return RLImpl.COLOR_GRAY;

  public static var COLOR_YELLOW(get, never): RLHandle;
  static inline function get_COLOR_YELLOW(): RLHandle return RLImpl.COLOR_YELLOW;

  public static var COLOR_GOLD(get, never): RLHandle;
  static inline function get_COLOR_GOLD(): RLHandle return RLImpl.COLOR_GOLD;

  public static var COLOR_ORANGE(get, never): RLHandle;
  static inline function get_COLOR_ORANGE(): RLHandle return RLImpl.COLOR_ORANGE;

  public static var COLOR_PINK(get, never): RLHandle;
  static inline function get_COLOR_PINK(): RLHandle return RLImpl.COLOR_PINK;

  public static var COLOR_RED(get, never): RLHandle;
  static inline function get_COLOR_RED(): RLHandle return RLImpl.COLOR_RED;

  public static var COLOR_MAROON(get, never): RLHandle;
  static inline function get_COLOR_MAROON(): RLHandle return RLImpl.COLOR_MAROON;

  public static var COLOR_GREEN(get, never): RLHandle;
  static inline function get_COLOR_GREEN(): RLHandle return RLImpl.COLOR_GREEN;

  public static var COLOR_LIME(get, never): RLHandle;
  static inline function get_COLOR_LIME(): RLHandle return RLImpl.COLOR_LIME;

  public static var COLOR_DARKGREEN(get, never): RLHandle;
  static inline function get_COLOR_DARKGREEN(): RLHandle return RLImpl.COLOR_DARKGREEN;

  public static var COLOR_SKYBLUE(get, never): RLHandle;
  static inline function get_COLOR_SKYBLUE(): RLHandle return RLImpl.COLOR_SKYBLUE;

  public static var COLOR_BLUE(get, never): RLHandle;
  static inline function get_COLOR_BLUE(): RLHandle return RLImpl.COLOR_BLUE;

  public static var COLOR_DARKBLUE(get, never): RLHandle;
  static inline function get_COLOR_DARKBLUE(): RLHandle return RLImpl.COLOR_DARKBLUE;

  public static var COLOR_PURPLE(get, never): RLHandle;
  static inline function get_COLOR_PURPLE(): RLHandle return RLImpl.COLOR_PURPLE;

  public static var COLOR_VIOLET(get, never): RLHandle;
  static inline function get_COLOR_VIOLET(): RLHandle return RLImpl.COLOR_VIOLET;

  public static var COLOR_DARKPURPLE(get, never): RLHandle;
  static inline function get_COLOR_DARKPURPLE(): RLHandle return RLImpl.COLOR_DARKPURPLE;

  public static var COLOR_BEIGE(get, never): RLHandle;
  static inline function get_COLOR_BEIGE(): RLHandle return RLImpl.COLOR_BEIGE;

  public static var COLOR_BROWN(get, never): RLHandle;
  static inline function get_COLOR_BROWN(): RLHandle return RLImpl.COLOR_BROWN;

  public static var COLOR_DARKBROWN(get, never): RLHandle;
  static inline function get_COLOR_DARKBROWN(): RLHandle return RLImpl.COLOR_DARKBROWN;

  public static var COLOR_DARKGRAY(get, never): RLHandle;
  static inline function get_COLOR_DARKGRAY(): RLHandle return RLImpl.COLOR_DARKGRAY;

  public static var COLOR_WHITE(get, never): RLHandle;
  static inline function get_COLOR_WHITE(): RLHandle return RLImpl.COLOR_WHITE;

  public static var COLOR_BLANK(get, never): RLHandle;
  static inline function get_COLOR_BLANK(): RLHandle return RLImpl.COLOR_BLANK;

  public static var COLOR_MAGENTA(get, never): RLHandle;
  static inline function get_COLOR_MAGENTA(): RLHandle return RLImpl.COLOR_MAGENTA;

  public static var COLOR_RAYWHITE(get, never): RLHandle;
  static inline function get_COLOR_RAYWHITE(): RLHandle return RLImpl.COLOR_RAYWHITE;

  public static var COLOR_BLACK(get, never): RLHandle;
  static inline function get_COLOR_BLACK(): RLHandle return RLImpl.COLOR_BLACK;

  public static function init(?config: RLInitConfig): Int {
    return RLImpl.init(config);
  }

  public static function initAsync(?config: RLInitConfig): Int {
    return RLImpl.initAsync(config);
  }
  ...
  public static function initValues(
    ...
    return RLImpl.initValues(width, height, title, flags, assetHost, loaderCacheDir);
  }
  ...
  public static function isInitialized(): Bool {
    return RLImpl.isInitialized();
  }

  public static function getPlatform(): String {
    return RLImpl.getPlatform();
  }
  ...
  public static function camera3dCreate(
    ...
    return RLImpl.camera3dCreate(positionX, positionY, positionZ, targetX, targetY, targetZ, upX, upY, upZ, fovy, projection);
  }
  ...
  public static function camera3dSet(
    ...
    return RLImpl.camera3dSet(camera, positionX, positionY, positionZ, targetX, targetY, targetZ, upX, upY, upZ, fovy, projection);
  }

  public static function camera3dSetActive(camera: RLHandle): Bool {
    return RLImpl.camera3dSetActive(camera);
  }

  public static function camera3dDestroy(camera: RLHandle): Void {
    RLImpl.camera3dDestroy(camera);
  }

  public static function modelCreate(filename: String): RLHandle {
    return RLImpl.modelCreate(filename);
  }
  ...
  public static function loaderCreateTaskGroup<T>(?onComplete:RLTaskGroupCallback<T>, ?onError:RLTaskGroupCallback<T>, ?ctx:T): RLTaskGroup {
    return RLImpl.loaderCreateTaskGroup(onComplete, onError, ctx);
  }

  public static function loaderTaskInvalid(): RLHandle {
    return RLImpl.loaderTaskInvalid();
  }

  public static function loaderTaskIsValid(task: RLHandle): Bool {
    return RLImpl.loaderTaskIsValid(task);
  }

  public static function loaderAddTask<T>(task: RLHandle,
    onSuccess: String->T->Void, onFailure: String->T->Void, ctx: T): Int {
    return RLImpl.loaderAddTask(task, onSuccess, onFailure, ctx);
  }
...
abstract RLImpl(RLNativeImpl) from RLNativeImpl to RLNativeImpl {
  ...
  public static function loaderImportAsset(filename: String): Int {
    return RLLoader.loaderImportAsset(filename);
  }
  ...
  static function loaderAddTaskNative(task: RLHandle,
