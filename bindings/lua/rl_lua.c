...
int luaopen_rl(lua_State *L)
{
    ...
    lua_pushinteger(L, RL_HANDLE_KIND_NONE);
    lua_setfield(L, -2, "HANDLE_KIND_NONE");
    lua_pushinteger(L, RL_HANDLE_KIND_COLOR);
    lua_setfield(L, -2, "HANDLE_KIND_COLOR");
    lua_pushinteger(L, RL_HANDLE_KIND_CAMERA3D);
    lua_setfield(L, -2, "HANDLE_KIND_CAMERA3D");
    lua_pushinteger(L, RL_HANDLE_KIND_FONT);
    lua_setfield(L, -2, "HANDLE_KIND_FONT");
    lua_pushinteger(L, RL_HANDLE_KIND_TEXTURE);
    lua_setfield(L, -2, "HANDLE_KIND_TEXTURE");
    lua_pushinteger(L, RL_HANDLE_KIND_SPRITE2D);
    lua_setfield(L, -2, "HANDLE_KIND_SPRITE2D");
    lua_pushinteger(L, RL_HANDLE_KIND_SPRITE3D);
    lua_setfield(L, -2, "HANDLE_KIND_SPRITE3D");
    lua_pushinteger(L, RL_HANDLE_KIND_MODEL);
    lua_setfield(L, -2, "HANDLE_KIND_MODEL");
    lua_pushinteger(L, RL_HANDLE_KIND_MODEL_ASSET);
    lua_setfield(L, -2, "HANDLE_KIND_MODEL_ASSET");
    lua_pushinteger(L, RL_HANDLE_KIND_SOUND);
    lua_setfield(L, -2, "HANDLE_KIND_SOUND");
    lua_pushinteger(L, RL_HANDLE_KIND_MUSIC);
