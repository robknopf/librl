...
- Handle type encoding (2026-05): 32-bit layout `[ kind:6 | generation:10 | index:16 ]`; `rl_handle_get_type()` + pool cross-type reject; bindings + remote builtin handles aligned
