...
- **Binding parity** — 231 public C functions in `docs/API.md`; JS/Haxe/Nim/Lua 231/231. Re-run `python3 tools/audit_binding_parity.py` after C API or binding changes.
