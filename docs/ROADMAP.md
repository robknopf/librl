...
- **Binding parity** — 208 public C functions in `docs/API.md`; JS/Haxe/Nim/Lua 208/208 (`scene.pick` maps `rl_scene_pick_to_scratch` → `rl_scene_pick` in the parity audit). Re-run `python3 tools/audit_binding_parity.py` after C API or binding changes.
