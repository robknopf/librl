...
const moduleUrl = new URL("examples/haxe/out/wasm/Main.js", pageBase).href;
...
async function loadModuleFactory(maxAttempts = 120, delayMs = 500) {
  ...
  throw new Error("Unable to load Haxe WASM module");
}
...
(async function () {
  try {
    ...
    console.log("Haxe WASM module initialized:", mod);
