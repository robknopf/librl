...
const moduleUrl = new URL("examples/c-simple/out/main.js", pageBase).href;
...
async function loadModuleFactory(maxAttempts = 120, delayMs = 500) {
  ...
  throw new Error("Unable to load C-simple WASM module");
}
...
(async function () {
  try {
    ...
    console.log("C-simple WASM module initialized:", mod);
